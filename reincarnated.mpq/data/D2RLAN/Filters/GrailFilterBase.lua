--- Filter Title: Grail Filter Base (V4)
--- Filter Type: (Base filter)
...
return {
    reload = "Base Grail Filter is applied",
    rules = {
...
188 -- item_addskill_tab 	-- stat = {index=188,op="==",value=X,param=Y},
							-- Check if item has "+X to class skill tree", replace X with amount of +skill, and Y with the class id (ID's can be found at the bottom of the document)
							-- op can be "==" for exactly equal, ">=" for equal and greater than, or "<=" for equal and less than
							-- param can be either a single or multiple ID's. If using multiple, seperate them with a comma and encase them in {}
189 -- unused
190 -- unused
